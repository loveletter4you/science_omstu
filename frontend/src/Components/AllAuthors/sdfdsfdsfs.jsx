            ...
            {props.authors.map(a => <div key={a.id}>
                ...
                <NavLink to={'/author/' + a.id}>
                    <div className={s.line}>
                        <div className={s.first}>{a.surname} &nbsp;</div>
                    </div>
                    <div className={s.line}>
                        <div className={s.first}>{a.name} &nbsp;</div>
                    </div>
                    <div className={s.line}>
                        <div className={s.first}>{a.patronymic} &nbsp;</div>
                    </div>
                </NavLink></div>)}
